...
public class ColorPickerDialog extends Dialog implements ColorPickerView.OnColorChangedListener, View.OnClickListener {
    ...
    private void setUp(int color) {
        View layout = getLayoutInflater().inflate(R.layout.dialog_color_picker, null);
    ...
    private void updateHexValue(int color) {
        ...
        } else mHexVal.setText(ColorPickerPreference.convertToRGB(color).toUpperCase(Locale.getDefault()));
        mHexVal.setTextColor(mHexDefaultTextColor);
    }
